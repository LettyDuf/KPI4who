...
- **Prochaine action recommandée** : **chantier 21 (vue Lexique) ACTIF, jalon B.0 livré.** Prochain pas : **validation par Lætitia de la classification de `inventaire-lexique.md` et des arbitrages A2 et A3**, puis ouverture des jalons B.1 à B.5 (rédaction des définitions canoniques de `lexique-source.md`, une passe par catégorie). Référence du chantier : `doc-contrats-lexique.md`. Autres pistes en attente : 24 (URLs partageables), 13.bis (chips de maturité), 25 (audit zones inactives) ; finitions transverses et dette inchangées. Tag de point de retour courant : `mvp-chantier-26-livre`.
- **Blocages / questions ouvertes** : jalons B.1 à B.5 en attente de la validation de la classification (`inventaire-lexique.md`) et des arbitrages A2 et A3 par Lætitia.
...
| B | Audit et source éditoriale : résoudre les 24 divergences, écarter les non-termes, classer en 5 catégories, rédiger `lexique-source.md`. Découpé B.0 à B.5. Le jalon le plus lourd. | 🟡 en cours, B.0 livré (inventaire des 142 libellés) |
...
**Prochaine action recommandée.** Jalon B.0 livré : inventaire `inventaire-lexique.md` (142 libellés classés en 5 catégories, fusions et divergences repérées) et outil `outils/extraire-term-def.js`. Prochain pas : validation de la classification et des arbitrages A2 et A3 par Lætitia, puis jalons B.1 à B.5 (rédaction des définitions canoniques, une passe par catégorie).
