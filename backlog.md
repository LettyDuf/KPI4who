...
- **Chantier 23 — état d'avancement** : 23.a ✅ · 23.b ✅ · 23.c ✅ · 23.d ✅ · 23.e ✅ · 23.f ✅ · **23.g 🟡 en cours** (23.g-1 ✅ scénario réécrit · 23.g-2 ✅ journal supprimé · 23.g-3 ✅ sentinelles I1-I6 figées · 23.g-4.1 ✅ squelette harnais + générateur · **23.g-4.2 🔴 section A complète** · **23.g-4.3 🔴 section B sentinelles** · **23.g-4.4 🔴 outil compagnon + clôture**).
...
- **Mockups produits cette séance prolongée** : aucun. **Harnais de tests produit en 23.g-4.1** : `tests-accueil-unifie.html` (1226 l. dont 774 injectées) + `outils/construire-tests-accueil-unifie.js` (170 l.). Smoke-test 4/4 verts.
...
- **Prochaine action recommandée** : enchaîner sur **23.g-4.2 — section A complète** (tests unitaires sur stubs). Couverture cible : sélection/désélection multi-chips (probleme/cadre), persistance via Preferences (relancer `init()` → état restauré), libellé d'axes actifs sur les 4 patterns français (0 / 1 / 2 / 3+ lentilles), libellé canonique vide *« Aucun indicateur ne combine ces lentilles. »* (validation préalable C3), comportements limites (axe inconnu, chip déjà sélectionnée, valeur invalide). Effort estimé ~45-60 min. Patron stub déjà éprouvé en 23.g-4.1 — pas de friction architecturale attendue. Itération sur le même `tests-accueil-unifie.html` (régénération du bloc d'injection inutile pour cette étape, on n'ajoute que des tests dans le bloc final).
