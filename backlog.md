...
- **Prochaine action recommandée** : **chantier 21, jalon B.1 en cours.** Premier lot du rayon anti-patterns rédigé dans `lexique-source.md` (12 entrées sur 49), voix éditoriale à valider par Lætitia. Prochain pas : poursuivre la rédaction des anti-patterns par lots (37 restantes), puis les rayons cadres, indicateurs, concepts et auteurs (jalons B.2 à B.5). Arbitrages A2 (classification) et A3 (famille outcome) portés avec recommandation, corrigeables à la relecture. Référence : `doc-contrats-lexique.md`. Autres pistes en attente : 24, 13.bis, 25. Tag de point de retour courant : `mvp-chantier-26-livre`.
- **Blocages / questions ouvertes** : aucun. Point de revue ouvert : la voix éditoriale du premier lot d'anti-patterns (`lexique-source.md`) est à valider par Lætitia avant de produire le reste du rayon.
...
| B | Audit et source éditoriale : résoudre les 24 divergences, écarter les non-termes, classer en 5 catégories, rédiger `lexique-source.md`. Découpé B.0 à B.5. Le jalon le plus lourd. | 🟡 en cours, B.0 et premier lot B.1 livrés |
...
**Prochaine action recommandée.** Jalon B.1 en cours : `lexique-source.md` créé, format d'une entrée arrêté, premier lot du rayon anti-patterns rédigé (12 entrées sur 49). Prochain pas : poursuivre les anti-patterns par lots, puis les rayons cadres, indicateurs, concepts et auteurs (jalons B.2 à B.5).
