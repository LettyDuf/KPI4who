...
| B | Audit et source éditoriale : résoudre les 24 divergences, écarter les non-termes, classer en 4 catégories, rédiger `lexique-source.md`. Découpé B.0 à B.4. Le jalon le plus lourd. | 🟡 en cours, B.0 livré (inventaire des 142 libellés) |
...
**Prochaine action recommandée.** Jalon B.0 livré : inventaire `inventaire-lexique.md` (142 libellés classés en 4 catégories, non-termes et divergences repérés) et outil `outils/extraire-term-def.js`. Prochain pas : validation de la classification et des arbitrages A1 à A3 par Lætitia, puis jalons B.1 à B.4 (rédaction des définitions canoniques, une passe par catégorie).
