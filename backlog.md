...
- **Dernier SHA sur `main`** : à remettre à jour juste après le commit de clôture de cette session. Commits de la journée du 22/04 : `d3bfaf9` (MISSION.md), `b08118e` (fix Maturité), `4a1bd86` (chantier 9), `d133422` (chantiers 10 et 11), `06902d2` (État courant post-mission), puis commit courant (clean-up 7.8).
