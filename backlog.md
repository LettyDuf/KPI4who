...
- **Prochaine action recommandée** : **chantier 21 (vue Lexique) ACTIF, jalon A livré.** Prochain pas : **jalon B, audit éditorial des 142 libellés term-def** (résoudre les 24 divergences, écarter les non-termes, classer en 4 catégories, rédiger `lexique-source.md`), à ouvrir par une extraction outillée des term-def puis une revue par catégorie avec Lætitia. Référence du chantier : doc compagnon `doc-contrats-lexique.md`. Autres pistes en attente : 24 (URLs partageables des filtres), 13.bis (chips de maturité cumulables), 25 (audit des zones de code inactives) ; finitions transverses : brancher les liens sortants des fiches-questions vers une vue d'ensemble de cadre, 26.c4.coll.2 (crossLink cascade ↔ pasteque) ; dette : 26.c1.coll.1 (audit NBSP module fiche-question), constat n°10 (cadres restants : commercial, PMI/EVM, GRC-conformité, RH analytique), constat n°8 (corpus Scrum). Tag de point de retour courant : `mvp-chantier-26-livre`.
