...
- **Seuils / paliers** : Lætitia a exprimé l'hésitation « crainte de limitations non souhaitées ». À mockuper en ouverture de (b) avec 2-3 options (pas de champ / champ libre / champ structuré) avant de trancher. Si intégration : candidats = `{cible, seuilAlerte, unité}`.
