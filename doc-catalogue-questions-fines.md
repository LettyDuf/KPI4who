...
| 8 | **Mécanisme de cross-link entre fiches-questions** | 🟡 partiellement matérialisée 07/05/2026 — la fiche pastèque (commit `f5fb2df`) active le cross-link vers la fiche d'amélioration continue. Réciproque à activer dans `mockup-format-fiche-question.html` (qui annonce déjà ce cross-link comme « fiche-question à venir »). Format technique acté : `<div class="cross-link">Question liée — <a href="#question=...">…</a></div>`, italique discret sous Recommandation | Activer la réciproque |
