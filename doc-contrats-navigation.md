...
- **D2 + D4 (responsive) traités comme un bloc** — les previews lentilles A/B/C tiennent compte du responsive en filigrane, autant les arbitrer ensemble. La nav à 8 entrées augmente la pression responsive et certaines variantes deviennent intenables sur petit écran.
...
2. **Étape 2 — D2 + D4 ensemble.** Reprendre les previews lentilles A/B/C, les recadrer pour le libellé *Par mes 4 axes*, arbitrer en intégrant le responsive.
