...
**origine** : L'expérience client comme discipline de mesure s'est structurée autour de deux écoles. Fred Reichheld propose en 2003 le <span class="traduction">Net Promoter Score</span> (NPS) dans <span class="traduction">The Ultimate Question</span> : une seule question, recommanderiez-vous, pour mesurer la loyauté. Matthew Dixon renverse la perspective dans <span class="traduction">The Effortless Experience</span> : ce qui fidélise n'est pas d'enchanter le client, c'est de lui épargner de l'effort, d'où le <span class="traduction">Customer Effort Score</span> (CES).

**philosophie** : Le cadre part d'une conviction : ce que le client ressent d'une interaction prédit son comportement futur mieux que ce que l'entreprise croit lui avoir livré. Mesurer l'expérience, c'est écouter le client directement, pas déduire sa satisfaction de ses achats.

D'où trois angles complémentaires, jamais un seul : est-il satisfait sur le moment, l'effort qu'on lui a demandé était-il raisonnable, et recommanderait-il. Chacun capte une facette que les deux autres manquent.

**panel** : Fred Reichheld (Net Promoter Score, The Ultimate Question) ; Matthew Dixon (Customer Effort Score, The Effortless Experience).

**signatures** : af-sc1, af-sc3, s2

**lecture** : Les trois mesures se lisent en triangle, chacune corrigeant l'angle mort des autres. Le <a href="#fiche=af-sc1">score de satisfaction (CSAT)</a> capte le ressenti immédiat après une interaction ; le <a href="#fiche=af-sc3">score d'effort (CES)</a> capte ce que résoudre son problème a coûté au client, meilleur prédicteur de fidélité selon Dixon ; l'<a href="#fiche=s2">indice de recommandation (NPS)</a> capte la loyauté durable, celle de Reichheld. Un client satisfait sur le moment mais épuisé par l'effort ne reviendra pas ; les trois ensemble disent ce qu'un seul cache.

**antiPatterns** : <span class="term-def" data-def="NPS transformé en objectif de prime : lier la rémunération des équipes au score NPS. La conséquence connue est la sollicitation orientée, on ne demande son avis qu'aux clients satisfaits, et le score monte sans que la loyauté change (effet Goodhart).">NPS de prime</span>, <span class="term-def" data-def="Sur-sollicitation : multiplier les enquêtes après chaque micro-interaction. La lassitude fait chuter les taux de réponse et biaise l'échantillon vers les extrêmes ; on mesure les mécontents et les militants, plus la majorité.">sur-sollicitation</span>, et la moyenne unique : réduire l'expérience à un score agrégé sans lire les verbatims, c'est perdre le pourquoi que le chiffre ne donne jamais.

**quandChoisir** : Excellent pour une organisation de service ou de produit qui veut piloter la relation client sur du ressenti réel plutôt que sur des proxys internes : c'est le cadre le plus direct pour entendre le client.

**quandSeMefier** : Déçoit pris isolément et sans les verbatims : un score de recommandation seul dit qu'il y a un problème, jamais lequel. Très sensible au biais d'échantillonnage et à la manipulation dès qu'il devient une cible, il se lit avec le qualitatif, pas à sa place.

**allerPlusLoin** : The Ultimate Question 2.0 (Reichheld) ; The Effortless Experience (Dixon, Toman, DeLisi).

## itil

**statut** : cadre

**origine** : ITIL (<span class="traduction">Information Technology Infrastructure Library</span>) est un référentiel de gestion des services informatiques né dans l'administration britannique dans les années 1980, devenu le standard mondial de l'ITSM (<span class="traduction">IT Service Management</span>). Il ne décrit pas comment construire un logiciel, mais comment exploiter un service dans la durée : traiter les incidents, prévenir leur récurrence, tenir des engagements de niveau de service.

**philosophie** : Le cadre part d'un déplacement : la valeur d'un système informatique ne se joue pas seulement à sa livraison, mais dans les mois et les années où il rend service. Un service qui tombe souvent, se rétablit lentement ou re-casse toujours pour la même cause détruit la valeur qu'on a mise à le construire.

D'où une mesure centrée sur la tenue du service : à quelle vitesse on rétablit, combien de fois on résout du premier coup, si l'on respecte ce qu'on a promis, et si les incidents se répètent. La qualité perçue est ici une affaire d'exploitation, pas seulement de code.

**panel** : Le référentiel ITIL, corpus de bonnes pratiques de gestion des services informatiques (ITSM) ; proche des métriques DORA côté stabilité, sur le temps de rétablissement.

**signatures** : ti-o3, ti-o2, o4, ti-o4

**lecture** : Les quatre mesures décrivent la vie d'un service en exploitation. La <a href="#fiche=ti-o3">conformité SLA</a> dit si l'on tient ses engagements de niveau de service ; la <a href="#fiche=ti-o2">résolution au premier contact</a> dit si le support règle vraiment, sans balade entre les niveaux ; le <a href="#fiche=o4">temps de rétablissement (MTTR)</a> dit combien de temps un incident prive les utilisateurs ; le <a href="#fiche=ti-o4">taux de récurrence d'incidents</a> dit si l'on traite les causes ou seulement les symptômes. Un support rapide qui laisse revenir les mêmes pannes ne tient pas le service.

**antiPatterns** : <span class="term-def" data-def="Fermeture prématurée de tickets : clore un incident sans l'avoir vraiment résolu pour améliorer le temps de rétablissement ou la conformité SLA. Le chiffre s'embellit, l'utilisateur rouvre, le problème revient déguisé en nouvel incident.">fermeture prématurée</span>, <span class="term-def" data-def="Culte du SLA : optimiser la conformité aux délais contractuels au détriment de la résolution réelle. On traite vite ce qui compte pour le SLA, on néglige le reste ; le contrat est vert, l'utilisateur mécontent.">culte du SLA</span>, et l'oubli des causes profondes : suivre les incidents sans jamais mesurer leur récurrence, c'est écoper sans chercher la fuite.

**quandChoisir** : Excellent pour piloter l'exploitation d'un service dans la durée, un support, une infrastructure, un système en production dont la valeur dépend de la continuité plus que des nouveautés.

**quandSeMefier** : Déçoit comme cadre d'innovation ou de développement produit : il mesure la tenue de l'existant, pas la création de valeur nouvelle. Trop centré sur lui, il peut figer une organisation dans la stabilité au détriment du changement, et ses métriques de délai s'instrumentalisent facilement.

**allerPlusLoin** : Le corpus ITIL (bonnes pratiques ITSM) ; The Phoenix Project (Kim, Behr, Spafford) ; The Visible Ops Handbook (Behr, Kim, Spafford).

## securite

**statut** : cadre

**origine** : La mesure de la cybersécurité s'appuie sur des cadres normatifs plutôt que sur des auteurs. Le <span class="traduction">NIST Cybersecurity Framework</span> structure la sécurité en cinq fonctions : identifier, protéger, détecter, répondre, récupérer. La norme <span class="traduction">ISO/IEC 27035</span> précise la gestion des incidents de sécurité. Ensemble, ils donnent un langage commun pour mesurer la posture d'une organisation, pas seulement ses outils.

**philosophie** : Le cadre part d'un principe réaliste : on ne mesure pas la sécurité par l'absence d'incident, qui peut n'être qu'une détection défaillante. Ce qui compte, c'est la rapidité du cycle détecter, répondre, remédier, et la maturité des pratiques qui le soutiennent. Une organisation sûre n'est pas celle qui n'est jamais attaquée, c'est celle qui voit vite et se rétablit vite.

D'où une mesure en deux temps : la vitesse de réaction (détecter, rétablir, corriger les vulnérabilités) et la maturité de fond (la couverture des cinq fonctions du NIST). L'une dit comment on encaisse, l'autre si l'on progresse.

**panel** : Le NIST Cybersecurity Framework (cinq fonctions : identifier, protéger, détecter, répondre, récupérer) ; la norme ISO/IEC 27035 pour la gestion des incidents de sécurité.

**signatures** : s9, ti-s1, ti-s2, ti-s3

**lecture** : Les quatre mesures suivent le cycle de vie d'une menace. Le <a href="#fiche=ti-s1">délai de détection (MTTD)</a> dit combien de temps une attaque passe inaperçue, la vraie vulnérabilité ; le <a href="#fiche=ti-s2">temps de rétablissement sécurité</a> dit combien de temps le service reste compromis ; le <a href="#fiche=ti-s3">délai de remédiation des vulnérabilités</a> dit à quelle vitesse on ferme les portes connues, par sévérité ; l'<a href="#fiche=s9">indice de maturité cybersécurité</a> agrège la progression sur les cinq fonctions du NIST. Les trois premiers disent la réaction, le dernier la solidité de fond.

**antiPatterns** : <span class="term-def" data-def="Zéro incident comme preuve de sécurité : présenter l'absence d'incident déclaré comme un bon résultat. Le plus souvent, c'est un défaut de détection : on ne voit pas ce qu'on ne cherche pas. Un délai de détection élevé se cache derrière un tableau vert.">zéro incident trompeur</span>, <span class="term-def" data-def="Théâtre de la conformité : cocher les cases d'un référentiel (audit passé, certification obtenue) sans capacité réelle de détection et de réponse. La posture est certifiée, l'organisation reste aveugle.">théâtre de la conformité</span>, et la course au délai de remédiation qui pousse à fermer vite les vulnérabilités faciles en laissant traîner les critiques : segmenter par sévérité est indispensable.

**quandChoisir** : Excellent pour piloter la posture de sécurité d'une organisation au-delà des outils : il relie la réactivité opérationnelle (détecter, répondre) à la maturité de fond (les cinq fonctions), dans un langage partagé avec les auditeurs.
